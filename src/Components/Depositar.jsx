    ...
    <input onChange={(e) => inputValue = e.target.value} type="text" className='input-depositar' placeholder='$0.00'/>
            ...
            <Card.Body>
                ...
                <Collapse  title='Criptomonedas:'>
                    ...
                    <ItemDepositar coins={shibPrice} coin='LTC' wallet='ltc1qhkthlnurv6ce8n4uq7qk0pcjyah6f0uerg8acv' image='https://www.svgrepo.com/show/428651/litecoin-ltc-cryptocurrency.svg' text='LTC' price='Litecoin'/>
                    ...
                    <ItemDepositar coins={cakePrice} coin='DASH' wallet='XasxQKSbSZBfDAXRrRYZLrzXfp9MrtwGNn' image='https://www.svgrepo.com/show/428660/dash-cryptocurrency-coin.svg' text='DASH' price='Dash'/>
                    ...
                    <ItemDepositar coins={dotPrice} coin='SHIB' wallet='0x0148B7cE77aD688894aeCa413FD6B6378E7b032a' image='https://s2.coinmarketcap.com/static/img/coins/64x64/5994.png' text='SHIB' price='Shiba'/>
